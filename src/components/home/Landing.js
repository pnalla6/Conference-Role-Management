                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <Box pb={2}>
                            <Typography variant="body1" color="textPrimary" textAlign="center">
                                The ReviewerScope App provides a comprehensive solution for managing roles and tasks at conferences and events. With its intuitive interface and powerful features, it simplifies the process of assigning, tracking, and organizing roles for conference participants.
                            </Typography>
                        </Box>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                        <Box pb={2} textAlign="center">
                            ...
                            <Typography variant="body1" color="textPrimary">
                                Please feel free to reach out to us at contact@reviewerscope.com for any inquiries or assistance regarding the ReviewerScope App. We are here to support you and ensure a successful conference experience.
                            </Typography>
                        </Box>
                    </Grid>
                </Grid>
